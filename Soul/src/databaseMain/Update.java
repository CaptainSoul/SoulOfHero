	...
	private JButton getBtnArmor() {
		if (btnArmor == null) {
			...
			btnArmor.addMouseListener(new MouseAdapter() {
				@Override
				public void mouseClicked(MouseEvent e) {
					ArmorUpdate armorUpdate = new ArmorUpdate();
					armorUpdate.run();
					frame.dispose();
				}
			});
	...
	private JButton getBtnWeapon() {
		if (btnWeapon == null) {
			...
			btnWeapon.addMouseListener(new MouseAdapter() {
				@Override
				public void mouseClicked(MouseEvent e) {
					WeaponUpdate weaponUpdate = new WeaponUpdate();
					weaponUpdate.run();
					frame.dispose();
				}
			});
	...
	private JButton getBtnSkillBase() {
		if (btnSkillBase == null) {
			...
			btnSkillBase.addMouseListener(new MouseAdapter() {
				@Override
				public void mouseClicked(MouseEvent e) {
					SkillBaseUpdate skillBaseUpdate = new SkillBaseUpdate();
					skillBaseUpdate.run();
					frame.dispose();
				}
			});
	...
	private JButton getBtnSprite() {
		if (btnSprite == null) {
			...
			btnSprite.addMouseListener(new MouseAdapter() {
				@Override
				public void mouseClicked(MouseEvent e) {
					SpriteUpdate spriteUpdate = new SpriteUpdate();
					spriteUpdate.run();
					frame.dispose();
				}
			});
