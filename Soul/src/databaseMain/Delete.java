	...
	private JButton getBtnArmor() {
		if (btnArmor == null) {
			...
			btnArmor.addMouseListener(new MouseAdapter() {
				@Override
				public void mouseClicked(MouseEvent e) {
					ArmorDelete armorDelete = new ArmorDelete();
					armorDelete.run();
					frame.dispose();
				}
			});
	...
	private JButton getBtnWeapon() {
		if (btnWeapon == null) {
			...
			btnWeapon.addMouseListener(new MouseAdapter() {
				@Override
				public void mouseClicked(MouseEvent e) {
					WeaponDelete weaponDelete = new WeaponDelete();
					weaponDelete.run();
					frame.dispose();
				}
			});
	...
	private JButton getBtnSkillBase() {
		if (btnSkillBase == null) {
			...
			btnSkillBase.addMouseListener(new MouseAdapter() {
				@Override
				public void mouseClicked(MouseEvent e) {
					SkillBaseDelete skillBaseDelete = new SkillBaseDelete();
					skillBaseDelete.run();
					frame.dispose();
				}
			});
	...
	private JButton getBtnSprite() {
		if (btnSprite == null) {
			...
			btnSprite.addMouseListener(new MouseAdapter() {
				@Override
				public void mouseClicked(MouseEvent e) {
					SpriteDelete spriteDelete = new SpriteDelete();
					spriteDelete.run();
					frame.dispose();
				}
			});
