...
public class SpriteInsert {
	...
	public void run() {
		try {
			SpriteInsert window = new SpriteInsert();
	...
	private JPanel getContentPane() {
		if(contentPane == null) {
			...
			strength.setBounds(91, 161, 86, 24);
			...
			lblDefence.setBounds(203, 162, 41, 18);
			contentPane.add(lblDefence);
			
			defence = new JTextField();
			defence.setBounds(273, 161, 86, 24);
			...
			weaponCode.setBounds(177, 316, 163, 24);
			...
			inventoryCode.setBounds(177, 279, 163, 24);
			...
			btnInsert.setBounds(164, 390, 113, 27);
