...
public class SpriteQuery {
	...
	public void run() {
		try {
			SpriteQuery window = new SpriteQuery();
		...
		if(contentPane == null) {
			...
			btnInsert.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent event) {
					...
					hp.setText(""+sprite.getHp());
					mp.setText(""+sprite.getMp());
					strength.setText(""+sprite.getStrength());
					defence.setText(""+sprite.getDefence());
					exp.setText(""+sprite.getExp());
					level.setText(""+sprite.getLevel());
					gold.setText(""+sprite.getGold());
					move.setText(""+sprite.getMove());
					armorCode.setText(""+sprite.getArmorCode());
					weaponCode.setText(""+sprite.getWeaponCode());
					inventoryCode.setText(""+sprite.getInventoryCode());
					group.setText(""+sprite.getGroup());
				}
			});
